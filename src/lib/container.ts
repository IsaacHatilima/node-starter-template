...
type ServiceClasses = typeof Container.prototype.services;

type ContainerServices = {
    [K in keyof ServiceClasses]: InstanceType<ServiceClasses[K]>;
};
...
export const container = new Container() as Container & ContainerServices;
